...
//    public static partial class SpaUtils {

//        internal static class Domains {

//            public static bool FindDomain(IPublishedSnapshot publishedSnapshot, SpaRequest request, Uri uri) {
...
//            private static DomainAndUri SelectDomain(IEnumerable<Domain> domains, Uri uri, string culture = null, string defaultCulture = null, Func<IReadOnlyCollection<DomainAndUri>, Uri, string, string, DomainAndUri> filter = null) {
...
//            public static DomainAndUri DomainForNode(IDomainCache domainCache, ISiteDomainHelper siteDomainHelper, int nodeId, Uri current, string culture = null) {
